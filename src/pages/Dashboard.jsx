                ...
                >
                  <div className="text-center">
                    <div className="radio-toolbar">
                      ...
                      />
                      <label className="m-1" htmlFor="ContentPlaceHolder1_radioBnb">BNB</label>
                      <input
                        defaultValue="ETH"
                        name="ctl00$ContentPlaceHolder1$radioCrypto"
                        type="radio"
                      ...
                      />
                      <label className="m-1" htmlFor="ContentPlaceHolder1_radioEth">ETH</label>
                    </div>
                  </div>
                  <div className="text-center">
        ...
        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6">
          <div className="card card-stats total_txn_box">
            <div className="card-header card-header-primary card-header-icon">
              ...
              <p className="card-category text-white">Total Txn. (in $)</p>
        ...
        <div className="col-xl-3 col-lg-6 col-md-6 col-sm-6">
          <div className="card card-stats token_value_box">
            <div className="card-header card-header-success card-header-icon">
              ...
              <h3 className="card-title text-white">
                <span id="ContentPlaceHolder1_tokens_value_lbl">$ 0.0000</span>
              </h3>
            </div>
            <div className="card-footer">
              <div className="stats">
