    ...
    >
      ...
      >
        <a className="navbar-brand" href="#">
          <img style={{ width: 175 }} src="assets/logo/mazimatic_logo_db.png" />
        </a>
        <button
      ...
      <div className="container-fluid" id="home">
        <div className="row">
          ...
          <div className="col-lg-4">
            {/* Step-1 start */}
            {/* <div id="signin_pnl" class="cards">
  
                              <div class="card-title pt-3">
                                  <h3>Pre-Sale Price</h3>
                                  <h1 class="price-rate">$
                                      <span id="signin_pnl_token_rate_lbl">0.0035</span></h1>
                              </div>
                              <div class="progress_pd">
                                  <div class="progress">
                                      <div class='progress-bar' role='progressbar' aria-label='Info example' style='width: 71%' aria-valuenow='71' aria-valuemin='0' aria-valuemax='100'></div>
                                      
                                      <p>PRE-SALE METER</p>
                                  </div>
                              </div>
                              <div class="content-card d-flex justify-content-around">
                                  <p class="title1">Excited</p>
                                  <p class="title2">Over the Moon</p>
                                  <p class="title3">Missed it</p>
                              </div>
                              <div class="card-middle-title">
                                  <h1 class="card-sign-up">SIGN UP /LOG IN</h1>
                                  <h2 class="card-middle-text">Enter your Email</h2>
                                  <div class="email-enter">
                                      <label for="exampleFormControlInput1" class="form-label"></label>
                                      <input name="usernametxt" type="text" id="usernametxt" class="form-control" placeholder="johndoe@gmail.com" />
                                  </div>
                                  <div class="submit-button pb-5">
                                      <button onclick="__doPostBack('loginbtn','')" id="loginbtn" type="button" class="btn two"><span>Submit</span></button>
                                  </div>
                                  <div class="card-bottom-text">
                                      <p class="hr-lines">Payment Partners</p>
                                  </div>
                                  <div class="content-cards d-flex justify-content-around">
                                      <div class="coin-img"></div>
                                      <div class="payme-img"></div>
                                      <div class="upi-img"></div>
                                  </div>
                              </div>
                           </div>  */}
            {/*--- Step-1 End ---*/}
            ...
            {/* End */}
            {/* Step-3 */}
            {/* <div id="select_gateway_form" class="cards">
    
                              <div class="card-title pt-3">
                                  <h3>Pre-Sale Price</h3>
                                  <h1 class="price-rate">$
                                      <span id="select_gateway_form_token_rate_lbl">0.0035</span></h1>
                              </div>
                              <div class="progress_pd">
                                  <div class="progress">
                                      <div class="progress-bar" role="progressbar" aria-label="Info example" style="width: 71%" aria-valuenow="71" aria-valuemin="0" aria-valuemax="100"></div>
                              ...
                              <div class="progress_pd">
                                  <div class="input-group mb-3">
                                      <button class="btns" type="button" id="button-addon1">AMOUNT in $</button>
                                      <input name="total_amt_txt" type="text" onchange="javascript:setTimeout('__doPostBack(\'total_amt_txt\',\'\')', 0)" onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;" id="total_amt_txt" class="form-control dash_input" placeholder="eg. 1000">
                                  </div>
                                  <div class="input-group mb-3">
                                      <button class="btns" type="button" id="button-addon1">TOKEN QTY</button>
                                      <input name="total_payable_tkn_lbl" type="text" readonly="readonly" id="total_payable_tkn_lbl" class="form-control dash_input" placeholder="0">
                                  </div>
                              </div>
                              <div class="payment">
                                  <p class="payment-title">Select your Blockchain</p>
                              </div>
                              <div class="checkbox text-center">
                                  <button class="btns check" type="button">
                                      <img src="tool_imgs/Binance.png" alt="">
                                      BNB
                                  <input value="BNB" name="radioCrypto" type="radio" id="radioBnb" checked="checked">
                                  </button>
                                  <button class="btns check-btn" type="button" id="button-addon2">
                                      <img src="tool_imgs/eth.png" alt="">
                                      Ethereum
                                  <input value="ETH" name="radioCrypto" type="radio" id="radioEth">
                              </button></div>
                              <div class="payment-method">
                                  <p class="payment-titles">Select your Payment Method</p>
                              </div>
                              <div class="content-cards d-flex justify-content-around radio_btn_hldr">
                                  <div class="coin-imgs">

                                      <div id="coinpayments_div" class="row payment_mth_1 mb-2 text-center pl_10">
                                          <div class="col-auto pt_7">
                                              <input value="crypto" name="radioGateway" type="radio" id="coinpayments_rdo" checked="checked">&nbsp;&nbsp;
                                      ...
                                      <div id="epay_div" class="row payment_mth_1 mb-2 text-center pl_10">
                                          <div class="col-auto pt_7">
                                              <input value="card" name="radioGateway" type="radio" id="epay_rdo" checked="checked">&nbsp;&nbsp;
                                      ...
                                      <div id="upi_div" class="row payment_mth_1 mb-2 text-center pl_10">
                                          <div class="col-auto pt_7">
                                              <input value="upi" name="radioGateway" type="radio" id="upi_rdo" checked="checked">&nbsp;&nbsp;
                                      ...
                                      <div class="text-center">
                                          <input type="submit" name="buynowbtn" value="Buy Now" id="buynowbtn" class="buy_button">
                                      </div>
                                  </div>
                              </div>
    ...
    <div className="container-fluid">
      <div>
        ...
        <a href="https://t.me/mazimatic" target="_blank">
          <img src="assets/images/icons/telegram.svg" className="float2" />
        </a>
        <a href="https://m.facebook.com/mazimatic/" target="_blank">
          <img src="assets/images/icons/facebook.svg" className="float3" />
        </a>
        <a href="https://twitter.com/mazimatic?s=11" target="_blank">
          <img src="assets/images/icons/twitter.svg" className="float4" />
        </a>
        <a href="https://discord.gg/gcYZhMA6" target="_blank">
          <img src="assets/images/icons/discord.png" className="float5" />
        </a>
        <a href="https://www.youtube.com/watch?v=3MgqYz90GCM" target="_blank">
          <img src="assets/images/icons/youtube.png" className="float6" />
        </a>
        <div className="top-wrapper">
          ...
          >
            <a className="navbar-brand" href="./">
              <img
                src="assets/images/logo/mazimatic_logo_db.png"
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav ml-auto desktop-links">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="#Verse">
                    MaziVerse
                  </a>
                </li>
                <li className="nav-item dropdown-link">
                  <a
                    ...
                    style={{ color: "rgb(37, 255, 33)" }}
                  >
                    NFT
                  </a>
                  <div className="dropdown-div" id="drop_1">
                    <a href="pitchdeck" target="_blank">
                      NFT Pitchdeck
                    </a>
                    <br />
                    <a href="nft">Buy NFTs</a>
                    <br />
                    <a
                ...
                <li className="nav-item">
                  <a className="nav-link" target="_blank" href="whitepaper">
                    Whitepaper
                  </a>
                </li>
                <li className="nav-item">
              ...
              <ul className="navbar-nav ml-auto mobile-links">
                <li className="nav-item">
                  <a className="nav-link" href="#OurVisionMobile">
                    Our Vision
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="#VerseMobile">
                    MaziVerse
                  </a>
                </li>
                <li className="nav-item dropdown-link">
                  <a className="nav-link dropdown-toggle">NFT</a>
                  <div className="dropdown-div" id="mobile_drop_1">
                    <a href="pitchdeck" target="_blank">
                      NFT Pitchdeck
                    </a>
                    <br />
                ...
                <li className="nav-item">
                  <a className="nav-link" href="#RoadmapMobile">
                    Roadmap
                  </a>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="#FeaturesMobile">
                    Features
                  </a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="#ContactMobile">
                    Contact Us
                  </a>
                </li>
              </ul>
            ...
            <div className="row">
              ...
              <div className="col-md-6">
                <p>
                  ...
                  <span>
                    Provide a never-like-before real world casino experience.
                  </span>
                ...
                <p>
                  <img src="assets/images/vision-line.svg" />
                  <span>Foster a high performing VR gaming environment</span>
                  that rewards players generously. A platform that enables you
                  to connect &amp; play with friends anywhere in the world.
                </p>
                <p>
                  <img src="assets/images/vision-line.svg" />
                  <span>
                    Create a safe, secure and trust worthy Metaverse platform.
                  </span>{" "}
                  Use solid &amp; bleeding edge web3 technology that scales to
        ...
        <section id="OurVisionMobile">
          ...
          <div className="row">
            <div className="col-md-12 text-center">
              ...
              <p className="mt-4">
                <span>Foster a high performing VR gaming environment</span> that
                rewards players generously. A platform that enables you to
                connect &amp; play with friends anywhere in the world.
              </p>
              <p className="mt-4">
                <span>
                  Create a safe, secure and trust worthy Metaverse platform.
        ...
        <section id="Press">
          <h3>
            <img src="assets/images/press-line.svg" className="left-line" />
            In the Press
            <img src="assets/images/press-line.svg" className="right-line" />
          </h3>
          <div className="row mt-5">
            <div className="col-6 col-md-3 text-center">
              <a href="https://www.forbes.com/billionaires/" target="_blank">
            ...
            <div className="col-6 col-md-3 text-center">
              <a
                ...
                target="_blank"
              >
                <img src="assets/images/logo/kjtimes.png" alt="khaleejtimes" />
              </a>
            </div>
            <div className="col-6 col-md-3 text-center">
              <a
            ...
            <div className="col-6 col-md-3 text-center">
              <a
                ...
                target="_blank"
              >
                <img src="assets/images/logo/medium.png" alt="medium-blog" />
              </a>
            </div>
            <div className="col-6 col-md-3 text-center">
              <a
          ...
          <div className="verse-divs" id="verse-1-div">
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-6">
                <h3>CASINO VERSE</h3>
                <p>
                  We decided to take online casinos to a fascinating new level.
                  Inside this virtual reality casino, you can play, win and earn
                  while having a lot more fun. Bring your friends, family along
                  into this alternate reality - no matter in which part of the
                  world they are. Playing inside the casinoverse, you are
                  attended by real croupiers and pit managers. The dealers
                  assisting you are real people in real mega casinos across the
                  world and it is live streamed! How cool is that? This new
                  approach of live streaming games helps averting manipulation
                  and ensures that users get good value for money. With this
                  revolutionary approach we put a stop to bots and
                  pre-programmed gaming outcomes, that always act to the benefit
                  of the house. In casinoverse YOU win!
                </p>
              </div>
              <div className="col-md-3 col-sm-3">
          ...
          <div className="verse-divs" id="verse-2-div">
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-6">
                <h3>PARTY VERSE</h3>
                <p>
                  A casino is never complete without a good party :) Partyverse
                  is yet another magnificent realm inside the Maziverse. Just
                  jump inside this virtual club and join thousands of others in
                  a never ending exotic party. You see live artists performing
                  inside with incredible club music that gets you tapping your
                  feet along with a fun crowd. There will be hundreds of parties
                  happening inside the party verse and you get to teleport to
                  any party of choice. Each party will have its own theme,
                  audience, artists etc. By just holding one of Mazimatic's NFT,
                  you get un-limited access to the entire party verse.
                </p>
              </div>
              <div className="col-md-3 col-sm-3">
                <img src="assets/images/close.svg" className="close" />
          ...
          <div className="verse-divs" id="verse-3-div">
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-6">
                ...
                <p>
                  Step out of the club and land right inside a wonderland filled
                  with adventure. The night is still young inside the maziverse,
                  so you can spend time inside the Adventureverse and go for the
                  ride of your life. This massive VR stimulation brings to life
                  every great attraction you wanted to visit in this world. Just
                  wear your head gear and the next moment you will be flying
                  through the clouds of Burj Khalifa, Effiel tower -or- go scuba
                  diving to the deepest depths of the marina trench. The
                  adventure verse is a dream come true for every metaverse
                  enthusiast.
                </p>
              </div>
              <div className="col-md-3 col-sm-3">
          ...
          <div className="verse-divs" id="verse-4-div">
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-6">
                ...
                <p>
                  The MaziVerse is more than just playing, earning and clubbing.
                  A separate world is dedicated to interact with influencers who
                  you've always admired. Inside the Influencerverse, you are
                  free to connect and talk to them in real-time. In whichever
                  part of the world your influencer is, inside the
                  influencerverse he or she sits right beside you spending
                  quality time.
                </p>
              </div>
              <div className="col-md-3 col-sm-3">
          ...
          <div className="verse-divs" id="verse-5-div">
            ...
            <div className="row">
              ...
              <div className="col-md-6 col-sm-6">
                ...
                <p>
                  A Metaverse built for the Trading community whether it is
                  Forex, NYSE or the Indian Stock Market, The Trading Floor is
                  the World’s first Metaverse for the Trading community, where
                  users will be able to interact with their friends, discuss
                  trading strategies and Execute trades inside the metaverse.
                  The Trading Floor will enable integrating the real trading
                  accounts within our virtual machines.
                </p>
              </div>
              <div className="col-md-3 col-sm-3">
                <img src="assets/images/close.svg" className="close" />
          ...
          <div className="row verse_p_row">
            ...
            <div className="col-md-5 text-center">
              <p className="verse_p">
                ...
                entertaining manner. Maziverse will be a futuristic gaming
                platform for users to meet, earn and play casino games. Running
                it on the revolutionary Polygon Blockchain helps to keep it
                decentralised and secure while maintaining very low on-chain
                transaction fees. Along with gaming,
              </p>
            </div>
            <div className="col-md-5 text-center">
              <p className="verse_p">
                the Maziverse goes the extra mile to provide mind blowing
                clubbing and social living experiences in a spectacular VR-AR
                environment
              </p>
              <p className="verse_p">
                Be it on the mobile, desktop or using virtual reality goggles,
                our promise is to enable a spectacular roller coster ride from
                start to end. The Maziverse is made up of four realms:
                Casinoverse, Partyverse, Adventureverse and the Influencerverse.
              </p>
            </div>
            <div className="col-md-1" />
          </div>
          ...
          <div className="row mt-5 mb-5">
            ...
            <div className="col-6 col-md-2 text-center">
              <a href="https://www.huffpost.com/" target="_blank">
                <img src="assets/images/logo/sec3.png" alt="trusted-verified" />
              </a>
            </div>
            <div className="col-6 col-md-2 text-center">
        ...
        <section id="Nftkart">
          ...
          <div className="row">
            ...
            <div className="col-md-5 col-sm-5 right-div">
              ...
              <p className="first-p">
                <span>
                  NFT's are the darling of Web3 and Maziverse is incomplete
                  without its exclusive collection.
                </span>{" "}
              ...
              <p>
                ...
                Cartier Roulette wheels, users will also be able to mint their
                own tokens as well. These non-fungible tokens will also be
                integrated seamlessly in the gameplay which will add more value
                to multiplayer gaming.
              </p>
              <p>
                Furthermore, you can customise your avatar with NFT accessories
                from premium brands along with other luxury items. Everything in
                your widest desire is just a click away with our NFTs. Be it a
                swanky car or a lux yacht, you got everything required to make a
                splash. Use these fancy NFTs and make heads turn with your grand
                entry to the floor 😎
              </p>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-md-12 text-center">
              ...
              <h3>
                HOW WE ARE GOING
                <br />
                TO GO ABOUT <span>ACHIEVING THIS?</span>
              </h3>
            </div>
          </div>
          <div className="row">
            <div className="col-md-12" id="roadmap-slider">
              <div>
                <button className="roadmapprev">
                  <img src="assets/images/lt.png" style={{ width: "20%" }} />
                </button>
                <button className="roadmapnext">
                  <img src="assets/images/gt.png" style={{ width: "20%" }} />
                </button>
              </div>
              <div
                className="slick-slider slider-images slick-initialized"
                    ...
                    >
                      <div>
                        ...
                        >
                          ...
                          <p>
                            <img src="assets/images/check.svg" />
                            Casino license and live casino Agreement sign.
                          </p>
                          <p>
                            <img src="assets/images/check.svg" />
                      ...
                      <div>
                        ...
                        >
                          ...
                          <p>
                            ...
                            />
                            ICO and listing on Multiple exchanges including
                            Huobi, OKKEX and Gate.io.
                          </p>
                          <p>
                            <img
                              src="assets/images/loader.gif"
                          ...
                          <p>
                            ...
                            />
                            Official App Launch - MaziMatic (Apple, Android,
                            Windows and VR).
                          </p>
                          <p>
                            <img
                          ...
                          <p>
                            ...
                            />
                            Sports Betting and Fantasy Sports Integration.
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <p>
                            ...
                            />
                            Selected NFT's to partner as an Avatar in the
                            gameplay.
                          </p>
                        </div>
                      </div>
            ...
            <div className="row features-inner">
              ...
              <div className="col-md-4 col-sm-4 text-div">
                ...
                <ul>
                  ...
                  <li>
                    -&nbsp;&nbsp;&nbsp;&nbsp; Change tables/machines ( Free Play
                    )
                  </li>
                </ul>
              </div>
        ...
        <section id="Comingsoon">
          <div className="row">
            <div className="col-md-6 col-12 left text-center">
              ...
              <h2>Whitepaper</h2>
              <a target="_blank" href="whitepaper" className="whitepaper">
                View
              </a>
            </div>
            ...
            <div className="col-6 top-member text-center">
              ...
              <div className="row">
                <div className="col-md-12 text-center">
                  ...
                  <a href="https://twitter.com/karanbhandari10" target="_blank">
                    <img
            ...
            <div className="col-6 top-member mt-5 text-center">
              ...
              <div className="row">
                <div className="col-md-12 text-center">
                  ...
                  <a href="https://twitter.com/Princesehgal01" target="_blank">
                    <img
                      src="assets/images/icons/twitter.png"
                      className="social"
                    />
            ...
            <div className="col-6 top-member mt-5 text-center">
              ...
              <div className="row">
                <div className="col-md-12 text-center">
                  ...
                  <a href="https://twitter.com/cryptikdev" target="_blank">
                    <img
                      src="assets/images/icons/twitter.png"
                      className="social"
                    />
            ...
            <div className="col-6 top-member text-center">
              ...
              <div className="row">
                <div className="col-md-12 text-center">
                  ...
                  <a href="https://twitter.com/vineet_miskin" target="_blank">
                    <img
                      src="assets/images/icons/twitter.png"
                      className="social"
                    />
            ...
            <div className="col-6 top-member mt-5 text-center">
              ...
              <div className="row">
                <div className="col-md-12 text-center">
                  ...
                  <a href="https://twitter.com/unfollowsaket" target="_blank">
                    <img
                      src="assets/images/icons/twitter.png"
                      className="social"
                    />
            ...
            <div className="col-6 top-member text-center">
              ...
              <div className="row">
                <div className="col-md-12 text-center">
                  ...
                  <a href="https://twitter.com/relishthisperk" target="_blank">
                    <img
                      src="assets/images/icons/twitter.png"
                      className="social"
                    />
        ...
        <section id="Contact">
          ...
          <div className="row">
            ...
            <div className="col-md-8 col-sm-8">
              ...
              <input className="mt-4" type="submit" defaultValue="Send" />
            </div>
          </div>
        </section>
        ...
        <section id="FooterMobile">
          ...
          <div className="row">
            <div className="col-md-12 text-center top-div">
              ...
              <a href="https://twitter.com/mazimatic?s=11" target="_blank">
                <img src="assets/images/icons/twitter.svg" className="social" />
              </a>
            </div>
